...
using xdr::operator<;
    ...
    bool ExternalSystemAccountIDPoolEntryFrame::isAutoGenerated(ExternalSystemType externalSystemType) {
        return externalSystemType == ExternalSystemType::BITCOIN ||
               externalSystemType == ExternalSystemType::ETHEREUM ||
               externalSystemType == ExternalSystemType::SECURE_VOTE;
    }
