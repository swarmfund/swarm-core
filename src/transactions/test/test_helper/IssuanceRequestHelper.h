...
{	
	...
	public:
		...
		CreatePreIssuanceRequestResult applyCreatePreIssuanceRequest(Account& source, SecretKey& preIssuedAssetSigner, AssetCode assetCode, uint64_t amount,
			std::string reference, CreatePreIssuanceRequestResultCode expectedResult = CreatePreIssuanceRequestResultCode::CREATE_PREISSUANCE_REQUEST_SUCCESS);
		...
		CreateIssuanceRequestResult applyCreateIssuanceRequest(Account& source, AssetCode assetCode, uint64_t amount, BalanceID receiver,
			std::string reference, CreateIssuanceRequestResultCode expectedResult = CreateIssuanceRequestResultCode::CREATE_ISSUANCE_REQUEST_SUCCESS);
