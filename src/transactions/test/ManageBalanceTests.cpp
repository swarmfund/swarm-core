...
TEST_CASE("manage balance", "[dep_tx][manage_balance]")
{
    ...
    SECTION("Can create for account by himself")
    {
        ...
        {
            applyManageBalanceTx(app, account, account, accSeq++, balanceID, asset, ManageBalanceAction::DELETE, ManageBalanceResultCode::MALFORMED);
        }
    }
	...
	SECTION("Can create balance")
	{
        ...
        {
            applyManageBalanceTx(app, account2, account2, accSeq++, balanceID, asset, ManageBalanceAction::DELETE, ManageBalanceResultCode::MALFORMED);
        }
