...
TEST_CASE("VirtualClock::weekPassed", "[timer]")
{
    VirtualClock clock;

    VirtualClock::time_point time1 = clock.now();
    VirtualClock::time_point time2 = clock.now();
    auto tm_time1 = VirtualClock::pointToTm(time1);
